...
export default function Services() {
  ...
  return (
    <div className="flex justify-center items-center w-full py-16 lg:min-h-[70vh] bg-gradient-to-b from-gray-900 via-black to-gray-900">
      <div
        className={`z-10 w-full max-w-7xl px-4 sm:px-6 md:px-10 py-6 sm:py-10 transition-all duration-700 ease-out
          ${
      ...
      >
        ...
        {/* Services Cards */}
        <div className="flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-10 lg:gap-12 mt-8 sm:mt-12 lg:mt-16 text-white w-full">
          {/* Card 1 */}
